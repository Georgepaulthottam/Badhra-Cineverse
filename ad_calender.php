...
<div id="main-container" class="middle-section">
                ...
                <div class="calpopup" id="dateDetailsPopup">
                <div class="calpopup-content" id="calpopupContent">
...
<br><br><br>
    ...
    <script>
        ...
        function attachEventListenersToDates() {
            ...
            const popupContent = document.getElementById('calpopupContent');
